...
class RegisterRepositoryImp implements IRegisterRepository {
  ...
  @override
  Future<void> register(int id_usuario, String nombres, String apellidos, String fecha_nacimiento, String sexo, BigInt cel, String email) async {
    final repoResult = await client.query(QueryOptions(
        document: gql(registerQuery),
        fetchPolicy: FetchPolicy.noCache,
        variables: {"id_usuario": id_usuario, "nombres": nombres, "apellidos": apellidos, "fecha_nacimiento": fecha_nacimiento, "sexo": sexo, "cel": cel, "email": email}
        ,
